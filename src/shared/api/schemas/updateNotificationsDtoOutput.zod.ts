...
export const UpdateNotificationsDtoOutput = zod
  .object({
    email: zod
      .object({
...
export type UpdateNotificationsDtoOutput = zod.input<typeof UpdateNotificationsDtoOutput>;
export type UpdateNotificationsDtoOutputOutput = zod.output<typeof UpdateNotificationsDtoOutput>;
