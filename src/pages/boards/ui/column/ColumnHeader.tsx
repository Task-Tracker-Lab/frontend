...
export function TaskColumnHeader(props: TaskColumnHeaderProps) {
  const { tasksLength, title, color, boardSlug, projectSlug, className, value } = props;
    ...
    <div className={classNames('overflow-hidden', {}, [className])}>
      <div className="overflow-hidden">
        ...
        <div className="px-2.5">
          <CreateTaskInline projectSlug={projectSlug} boardSlug={boardSlug} columnId={columnId} />
        </div>
      </div>
    </div>
  );
